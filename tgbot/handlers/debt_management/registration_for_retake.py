...
login_request_text = "Пожалуйста, напишите название предмета, который хотите пересдать:"
...
def register_login_change(dp):
    dp.register_message_handler(send_login_request, ~UserTypeFilter("student"), content_types=['text'],
